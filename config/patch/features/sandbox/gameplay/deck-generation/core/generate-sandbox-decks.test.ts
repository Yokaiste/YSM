...
export default async function test(context: Parameters<typeof generateSandboxDecks>[0]) {
  ...
  const specialRuleRules = parseDivisionRules(
    [
  ...
  const divisionMemberNamesFromRules = parseDivisionMemberNames(
    [
  ...
  const multilineRuleMap = parseDivisionRules(
    [
