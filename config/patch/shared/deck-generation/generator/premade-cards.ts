...
function resolveCoverageFloor(
  ...
  // Greedy set cover. Each round picks the entity covering the most still-wanted
  // roles, so it only needs the maximum - sorting the whole roster to read the
  // first element made this the most expensive step in card selection.
