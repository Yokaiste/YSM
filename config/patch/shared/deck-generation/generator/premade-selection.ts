...
export function buildRoleSelections(args: {
  ...
  for (const perspective of perspectives) {
    ...
    const orderedCandidates = [...candidatePool].sort((left, right) => {
      const leftScore = scoreAnalysisForPerspective({
        analysis: left.analysis,
        role: roleDefinition,
        stats,
        perspective,
      });
      const rightScore = scoreAnalysisForPerspective({
    ...
    selections.push({
      ...
      roleScore: scoreAnalysisForPerspective({
        analysis: candidate.analysis,
        role: roleDefinition,
        stats,
        perspective,
...
function resolveRoleStrengthScore(
  ...
  const bestScore = scoreAnalysisForPerspective({
    analysis,
    role: roleDefinition,
    stats,
    perspective: 'best',
